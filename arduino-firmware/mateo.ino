...
void initQuantity(int i, const char* n, String  v1, const char* u){
  q[i].name=n;
  q[i].value1=v1;
  q[i].unit=u;  
  qn++;
...
void setup(){
  ...
  initQuantity(0, "Teplota", String(0.0), "C");
  initQuantity(1, "Tlak", String(0.0), "Pa");
  initQuantity(2, "Vlhkost", String(0.0), "%");
  initQuantity(3, "Směr větru", String(0.0), "pi/4");
  initQuantity(4, "Rychlost větru", String(0.0), "m/s");
